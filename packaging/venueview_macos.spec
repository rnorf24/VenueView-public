...
release_info = runpy.run_path(str(project_root / "packaging" / "release_info.py"))
project_version = release_info["read_project_version"](
...
exe = EXE(
    ...
    upx=False,
    console=False,
    icon=str(assets_root / "venueview.icns"),
)
...
app = BUNDLE(
    ...
    name="VenueView.app",
    icon=str(assets_root / "venueview.icns"),
    bundle_identifier="com.venueview.desktop",
    version=project_version,
    info_plist={
        "CFBundleDisplayName": "VenueView",
